...
#
# Those variables are automatically filled in the CI
# Except STRIPE_SECRET_KEY that has to be generated in Stripe
# and configured in Amplify Console manually
#
##########################
